...
def show_graph_infos():
    ...
    caracteristics = tk.Label(
        graph_info_frame, text='Les Caractéristiques de votre graphe: 'f' {is_simple} ,'f' {is_complete} ,'f' {is_related} et 'f' {is_euler}')
    caracteristics.pack()
...
def apply_algorithm():
    ...
    def draw_result_dijkstra():
        final_shape_dijkstra = G(
            Entries=run_dijkstra(), cout_exist=is_cout_var.get())
    ...
    if algorithm_name == 'Kruskal':
        ...
        kruskal_frame.pack()
        k_list = [(Entry_element[0] + Entry_element[2], Entry_element[1])
                  for Entry_element in my_graph.kruskal()]
        kruskal_header = tk.Label(
            kruskal_frame, text=f'list of edges : {k_list}', font='Arial 15')
        kruskal_header.pack()
        kruskal_draw_button = tk.Button(
            kruskal_frame, text="See also", command=draw_result_kruskal)
        ...
        def run_prime():
            ...
            prim_header = tk.Label(
                prim2_frame, text=f'The list edges  : {prime_list}', font='Arial 15')
            prim_header.pack()
            prim_draw_button = tk.Button(
                prim2_frame, text="See also", command=draw_result_prim)
        ...
        prime_start_node_entry = tk.Entry(
            prim_frame, textvariable=prime_start_node_variable)
        prime_start_node_entry.pack()
        prime_start_node_button = tk.Button(
            prim_frame, text="Start", command=run_prime)
        ...
        def run_dijkstra():
            ...
            dijkstra_table.pack()
            dijkstra_draw_button = tk.Button(
                dijkstra2_frame, text="See also", font='Arial 10')  # command=draw_result_dijkstra
        ...
        dijkstra_start_node_label = tk.Label(
            dijkstra_frame, text="Starting point: ")
        dijkstra_start_node_label.pack()
        dijkstra_start_node_entry = tk.Entry(
            dijkstra_frame, textvariable=dijkstra_start_node_variable)
        dijkstra_start_node_entry.pack()
        dijkstra_start_node_button = tk.Button(
            dijkstra_frame, text="Start", command=run_dijkstra)
        ...
        def run_bellmanf():
            ...
            bellmanf_table.pack()
            # command=draw_result_dijkstra
            bellmanf_draw_button = tk.Button(
                bellmanf2_frame, text="See also", )
        ...
        bellmanf_start_node_label = tk.Label(
            bellmanf_frame, text="Starting pointt: ")
        bellmanf_start_node_label.pack()
        bellmanf_start_node_entry = tk.Entry(
            bellmanf_frame, textvariable=bellmanf_start_node_variable)
        bellmanf_start_node_entry.pack()
        bellmanf_start_node_button = tk.Button(
            bellmanf_frame, text="Start", command=run_bellmanf)
...
def PageFour():
    ...
    main_label = tk.Label(
        Page4, text="Congratulations your graph is created", font="kefa 20", fg='red', bg='white')
    main_label.pack()
    Tracer_graph_label = tk.Label(
        Page4, text=" See your Graph :", bg='white', font="kefa 15")
    Tracer_graph_label.pack()
    Tracer_graph_button = tk.Button(
        Page4, text="See Graph", command=Tracer_graph)
    Tracer_graph_button.pack()
    Tracer_graph_info_label = tk.Label(
        Page4, text="See some informations about your graph :", bg='white', font="kefa 15")
    Tracer_graph_info_label.pack()
    Tracer_graph_info_button = tk.Button(
        Page4, text="See Now", command=show_graph_infos)
    Tracer_graph_info_button.pack()

    apply_algorithme_label = tk.Label(
        Page4, text="Would you like to know more features About \nyour graph so Choose your favorite algorithm ^^", bg='white', font="kefa 15")
    ...
    algorithm_apply_button = tk.Button(
        Page4, text='Apply Now', command=apply_algorithm)
...
def graph_info_page():
    ...
    lbl = tk.Label(Page2, text="Give the number of edges : ",
                   font='Times 20 ', bg="white")
    lbl.pack()

    edges_variable = tk.IntVar(Page2)
    Tailleentry = tk.Entry(Page2, font='Courier 10 ',
                           width=20, bg='lavender', textvariable=edges_variable)
    Tailleentry.pack()
    Tailleentry.focus_set()

    is_oriented_label = tk.Label(
        Page2, text="Give the type of graph:", font='Times 20 ', bg="white")
    is_oriented_label.pack()
    is_oriented_input = tk.Checkbutton(
        Page2, text="Oriented", variable=is_oriented_var, bg="white")
    is_oriented_input.pack()
    is_nonoriented_input = tk.Checkbutton(
        Page2, text="Non Oriented", bg="white")
    is_nonoriented_input.pack()

    is_cout_lbl = tk.Label(
        Page2, text="Would you like to be weighted ?", font='Times 20 ', bg="white")
    is_cout_lbl.pack()
    is_cout_entry = tk.Checkbutton(
        Page2, text="yes", variable=is_cout_var, bg="white")
    is_cout_entry.pack()
    ...
    def graph_edges_info_page():
        ...
        scroll_bar = tk.Scrollbar(
            Page3, orient="vertical", command=my_canvas.yview)
        ...
        third_page_header = tk.Label(
            Frame2, text="fill the boxes below", font="kefa 15", bg='white')
        ...
        def append_Entries():
            for Entry_element in widgets_Entries_list:
                if is_cout_var.get():
                    Entries.append(
                        (Entry_element[0].get(), Entry_element[1].get()))
                else:
        ...
        if is_cout_var.get():
            for i in range(edges_number):
                ...
                edge_weight_entry = tk.Entry(
                    Frame2, textvariable=edge_weight_variable)
                ...
                widgets_Entries_list.append(
                    (edge_name_entry, edge_weight_entry))
        ...
        show_Entries_button = tk.Button(
            Frame2, text="Creer le graphe", command=append_Entries, bg='#ADD8E6')
    ...
    submit_button = tk.Button(Page2, text='Submit',
                              command=graph_edges_info_page, bg='#ADD8E6')
...
def first_page():
    ...
    first_page_header = tk.Label(
        Page1, text="WSGraph Application provides you to \n Create graphs and apply a many algorithms\n ", bg='white', font='Kefa 18 ', fg='#5F9EA0')
    first_page_sub_header = tk.Label(
        Page1, text="Click in the button beLlow to begin", font='Kefa 18 ', bg='white', fg='black')
    first_page_header.pack()
    first_page_sub_header.pack()
    create_button = tk.Button(Page1, text="  Start ", bg='#ADD8E6',
                              fg='#4169E1', font='Kefa 8 bold ', command=graph_info_page)
...
def Plus_dinfo():
    ...
    Plusdinfo.pack()
    first_page_header = tk.Label(
        Plusdinfo, text="Ici vous allez trouver plus d'informations", font='Kefa 32 ', fg='#000')
    first_page_sub_header = tk.Label(
        Plusdinfo, text="C quoi la theori de graphe", font='Kefa 20 ', fg='#000')
    first_page_header.pack()
    first_page_sub_header.pack()
    create_button = tk.Button(
        Plusdinfo, text="  New graph ", bg='pink', command=graph_info_page)
...
menuBar.add_cascade(label="Home", menu=buttonHome,
                    command=first_page, font=("Kefa", 50))
menuBar.add_cascade(label="Plus d'informations",
                    menu=buttonAbtus, command=Plus_dinfo, font=("Kefa", 50))
